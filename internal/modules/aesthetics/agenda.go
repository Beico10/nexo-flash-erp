...
func (s *AgendaService) GetByID(ctx context.Context, tenantID, id string) (*Appointment, error) {
        return s.repo.GetByID(ctx, tenantID, id)
}

// ListByDate lista agendamentos do dia.
func (s *AgendaService) ListByDate(ctx context.Context, tenantID string, date time.Time) ([]*Appointment, error) {
        return s.repo.ListByDate(ctx, tenantID, date)
}
