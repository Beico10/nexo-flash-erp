...
// GetByID busca uma OS pelo ID.
func (s *OSService) GetByID(ctx context.Context, tenantID, id string) (*ServiceOrder, error) {
        return s.repo.GetByID(ctx, tenantID, id)
}

// ListOpen lista todas as OSs abertas do tenant.
func (s *OSService) ListOpen(ctx context.Context, tenantID string) ([]*ServiceOrder, error) {
        return s.repo.ListOpen(ctx, tenantID)
}

// Update atualiza uma OS existente.
func (s *OSService) Update(ctx context.Context, os *ServiceOrder) error {
        os.UpdatedAt = time.Now().UTC()
        return s.repo.Update(ctx, os)
}

// GetByPlate retorna o historico de OSs por placa do veiculo.
func (s *OSService) GetByPlate(ctx context.Context, tenantID, plate string) ([]*ServiceOrder, error) {
        return s.repo.GetByPlate(ctx, tenantID, plate)
}
